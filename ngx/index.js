...
var EliSensor = /** @class */ (function (_super) {
    ...
    EliSensor.prototype.getSensorList = function () { return cordova(this, "getSensorList", {}, arguments); };
    EliSensor.prototype.getCurrent = function () { return cordova(this, "getCurrent", {}, arguments); };
    EliSensor.prototype.watch = function (options) {
    ...
    EliSensor.pluginName = "EliSensor";
    EliSensor.plugin = "cordova-plugin-eli-sensor";
    EliSensor.pluginRef = "navigator.eliSensor";
    EliSensor.repo = "https://github.com/carlkroeger/cordova-plugin-eli-sensor.git";
    EliSensor.platforms = ["Android", "iOS"];
    EliSensor = __decorate([
        Injectable()
    ], EliSensor);
    return EliSensor;
}(IonicNativePlugin));
